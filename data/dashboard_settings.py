...
DASHBOARD_SECTIONS = [
    {
        ...
        "fields": [
            ...
            },
            {
                ...
                "help": "Right-click the channel in Discord and choose 'Copy Channel ID' (enable Developer Mode in Settings > Advanced first).",
            },
            {
                "key": "welcome_message",
                ...
                "help": "Use {user} to mention the new member and {server} for the server name.",
            },
            {
