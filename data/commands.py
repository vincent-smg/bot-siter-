    ...
    },
    {
        ...
        "commands": [
            ...
            },
            {
                ...
                "usage": "/setwitbotchannel <channel> <description of witbot>",
                "description": "Chats with ank bot with desired description of her",
            },
            {
                "name": "removewitbotchannel",
                "usage": "/removewitbotchannel",
                "description": "removes witbot channel",
            },
            {
                "name": "witbottalk",
                "usage": "/witbottalk <true or false>",
                "description": "Changes if witbot can talk or not",
            },
        ],
    },
    {
        ...
        "commands": [
            ...
            },
            {
                ...
                "usage": "/removewordfilter <word that was added>",
    ...
    },
    {
        ...
        "commands": [
            ...
            },
            {
                ...
                "usage": "/welcome <#channel> <text> <imageURL>",
                "description": "Configures the welcome message channel.",
            },
            {
                "name": "setgoodbyechannel",
                "usage": "/goodbye <#channel> <text> <imageURL>",
                "description": "Configures the goodbye message channel.",
            },
            {
                "name": "setdirtychannel",
                "usage": "/setdirtychannel <channel>",
                "description": "sets an nsfw channel",
            },
             {
                "name": "dirtyjoke",
                "usage": "/dirtyjoke",
